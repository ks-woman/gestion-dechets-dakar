        ...
        <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-blue-500 hover:shadow-lg transition">
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-800"><?php echo e($stats['total_users'] ?? 0); ?></p>
                    <p class="text-xs text-gray-400 mt-1">
                        <?php echo e($stats['total_menages'] ?? 0); ?> ménages | <?php echo e($stats['total_entreprises'] ?? 0); ?>
        ...
        <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-emerald-500 hover:shadow-lg transition">
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-800"><?php echo e($stats['total_collecteurs'] ?? 0); ?></p>
        ...
        <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-yellow-500 hover:shadow-lg transition">
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-800"><?php echo e($stats['total_collectes'] ?? 0); ?></p>
        ...
        <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-purple-500 hover:shadow-lg transition">
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-800"><?php echo e($stats['total_points_distribues'] ?? 0); ?></p>
    ...
    <script>
        ...
        new Chart(usersCtx, {
            ...
            data: {
                ...
                datasets: [{
                    data: [<?php echo e($stats['total_menages'] ?? 0); ?>, <?php echo e($stats['total_entreprises'] ?? 0); ?>,
