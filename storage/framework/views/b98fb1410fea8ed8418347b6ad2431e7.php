    ...
    <div class="space-y-6">
        ...
        <?php if(auth()->user()->kitTri): ?>
            ...
            <div
                ...
                <?php if($kit->statut == 'en_attente'): ?> border-yellow-500
                <?php elseif($kit->statut == 'actif'): ?> border-green-500
                <?php else: ?> border-gray-400 <?php endif; ?>">
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-gray-800 flex items-center gap-2">
                            ...
                            <span
                                ...
                                <?php if($kit->statut == 'en_attente'): ?> bg-yellow-100 text-yellow-800
                                <?php elseif($kit->statut == 'actif'): ?> bg-green-100 text-green-800
                        ...
                        <p class="text-sm text-gray-500 mt-1">
                            <strong>Type :</strong> <?php echo e(ucfirst($kit->type_kit ?? 'Standard')); ?>

                        </p>
                        <p class="text-sm text-gray-500">
                            <strong>Code :</strong> <span
                                class="font-mono text-xs bg-gray-100 px-2 py-1 rounded"><?php echo e($kit->code_qr); ?></span>
                        </p>
                        <?php if($kit->date_distribution): ?>
                            <p class="text-sm text-gray-500">
                                <strong>Livré le :</strong>
                                <?php echo e(\Carbon\Carbon::parse($kit->date_distribution)->format('d/m/Y')); ?>
            ...
            <div class="bg-white rounded-xl shadow p-6 border-l-4 border-emerald-500">
                ...
                <div id="modeEmploiContent" class="mt-4 hidden">
                    <div class="flex flex-col md:flex-row gap-6 items-center">
                        <!-- Image du prototype -->
                        <div class="flex-1">
                            <img src="<?php echo e(asset('images/prototypePoub.jpeg')); ?>" alt="Prototype du kit de tri"
            ...
            <div class="bg-white rounded-xl shadow p-4 border-l-4 border-yellow-500">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-2xl font-bold"><?php echo e(auth()->user()->score_total); ?></p>
                ...
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-xl font-bold">
                            ...
                            <?php else: ?>
                                <span class="text-gray-600"><?php echo e(auth()->user()->statut_compte); ?></span>
                            <?php endif; ?>
                        </p>
                    </div>
                    ...
                    <div class="space-y-3">
                        <?php $__currentLoopData = $collectes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $collecte): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                                <div>
                                    <p class="font-medium">
                                        <?php echo e(\Carbon\Carbon::parse($collecte->date_collecte)->format('d/m/Y')); ?></p>
                                    <p class="text-sm text-gray-500">
                                ...
                                <div class="text-right">
                                    <span
                                        class="bg-yellow-100 text-yellow-800 px-2 py-1 rounded text-sm">+<?php echo e($collecte->points_obtenus); ?>
