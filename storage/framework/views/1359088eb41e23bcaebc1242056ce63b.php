<?php $__env->startSection('title', 'Enregistrer une collecte'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="bg-white rounded-xl shadow-soft p-6 max-w-2xl mx-auto">
        ...
        <div class="mb-6 p-4 bg-gray-50 rounded-lg">
            <p class="font-semibold">Client : <?php echo e($client->prenom); ?> <?php echo e($client->nom); ?></p>
            <p class="text-sm text-gray-500"> <?php echo e($client->adresse); ?></p>
            <p class="text-sm text-gray-500"> <?php echo e($client->telephone); ?></p>
            <p class="text-sm text-gray-500">Quartier : <?php echo e($client->quartier); ?></p>
        </div>

        <form method="POST" action="<?php echo e(route('collecteur.collecte.enregistrer')); ?>">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.collecteur', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\gestion-dechets-dakar\resources\views/collecteur/enregistrer-collecte.blade.php ENDPATH**/ ?>