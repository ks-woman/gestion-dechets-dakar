    ...
    <div class="bg-white rounded-xl shadow-md">
        <div class="p-5 border-b flex justify-between items-center">
            ...
            <div class="flex gap-3">
                <a href="<?php echo e(route('admin.utilisateurs.create')); ?>"
                ...
                <div class="text-sm text-gray-500">
                    Total : <?php echo e($users->total()); ?> utilisateur(s)
                </div>
            </div>
        </div>
        ...
        <div class="p-4 border-b bg-gray-50">
            <form method="GET" action="<?php echo e(route('admin.utilisateurs')); ?>" class="flex gap-3">
                            ...
                            <td class="py-3">
                                ...
                                <?php else: ?>
                                    <span class="px-2 py-1 rounded text-xs bg-gray-100 text-gray-800">⚪
                                        <?php echo e($user->statut_compte); ?></span>
                                <?php endif; ?>
                            </td>
