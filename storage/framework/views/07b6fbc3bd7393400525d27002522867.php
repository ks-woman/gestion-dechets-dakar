        ...
        <div class="space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <p class="font-semibold"><?php echo e(auth()->user()->nom); ?></p>
                </div>
                <div>
                    <p class="text-gray-500 text-sm">Prénom</p>
                    <p class="font-semibold"><?php echo e(auth()->user()->prenom); ?></p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <p class="font-semibold"><?php echo e(auth()->user()->telephone); ?></p>
                </div>
                <div class="col-span-2">
                    <p class="text-gray-500 text-sm">Adresse</p>
                    <p class="font-semibold"><?php echo e(auth()->user()->adresse); ?></p>
                </div>
                <div>
                    <p class="text-gray-500 text-sm">Quartier</p>
                    <p class="font-semibold"><?php echo e(auth()->user()->quartier); ?></p>
                </div>
                <div>
                    <p class="text-gray-500 text-sm">Rôle</p>
                    <p class="font-semibold capitalize"><?php echo e(auth()->user()->role); ?></p>
                </div>
                <div>
                    <p class="text-gray-500 text-sm">Points</p>
                    <p class="font-semibold text-yellow-600"><?php echo e(auth()->user()->score_total); ?></p>
                </div>
                <div>
                    <p class="text-gray-500 text-sm">Niveau</p>
                    <p class="font-semibold capitalize"><?php echo e(auth()->user()->niveau); ?></p>
                </div>
                <div>
                    <p class="text-gray-500 text-sm">Statut du compte</p>
                    <p class="font-semibold"><?php echo e(auth()->user()->statut_compte); ?></p>
                </div>
                <div>
                    <p class="text-gray-500 text-sm">Date d'inscription</p>
                    <p class="font-semibold"><?php echo e(\Carbon\Carbon::parse(auth()->user()->date_inscription)->format('d/m/Y')); ?>
            ...
            <div class="mt-6 pt-4 border-t">
                ...
                <form method="POST" action="<?php echo e(route('profil.update')); ?>" class="space-y-4">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="col-span-2">
                            ...
                            <input type="text" name="quartier" value="<?php echo e(old('quartier', auth()->user()->quartier)); ?>"
                                class="w-full border rounded-lg p-2">
                        </div>
                    </div>
                    <button type="submit"
            ...
            <div class="mt-6 pt-4 border-t">
                ...
                <form method="POST" action="<?php echo e(route('profil.password')); ?>" class="space-y-4">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
                    <div>
...
<?php echo $__env->make('layouts.menage', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\gestion-dechets-dakar\resources\views/auth/profile.blade.php ENDPATH**/ ?>