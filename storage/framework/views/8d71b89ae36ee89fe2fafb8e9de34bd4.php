    ...
    <div class="space-y-6">
            ...
            <div class="card">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-emerald-600"><?php echo e($totalPoints ?? 0); ?></p>
                    </div>
        ...
        <div class="bg-emerald-50 border border-emerald-200 rounded-xl p-4 text-center">
            <p class="text-emerald-800">
                <span class="font-bold"><?php echo e($offresDisponibles ?? 0); ?></span> offre(s) disponible(s)
                    ...
                    <?php $__currentLoopData = $dernieresCommandes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $commande): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                            <div>
                                ...
                                <p class="text-sm text-gray-500"><?php echo e($commande->collecte->user->prenom ?? ''); ?>

                                    <?php echo e($commande->collecte->user->nom ?? ''); ?></p>
