...
<?php $__env->startSection('content'); ?>
    <div class="bg-white rounded-2xl shadow-2xl p-8">
        ...
        <p class="text-center text-gray-500 text-sm mt-6">
            ...
            <a href="<?php echo e(route('register')); ?>" class="text-emerald-600 hover:text-emerald-700 font-medium">
                Créer un compte
            </a>
        </p>
    </div>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\gestion-dechets-dakar\resources\views/auth/login.blade.php ENDPATH**/ ?>