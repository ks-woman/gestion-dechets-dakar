    ...
    <div class="bg-white rounded-xl shadow p-6">
        ...
        <div class="mt-6 pt-4 border-t border-gray-200">
            ...
            <div class="flex flex-wrap gap-2 justify-center mt-2">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $kitsEnAttente; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <button onclick="activerKit('<?php echo e($kit->code_qr); ?>')"
                        class="bg-emerald-500 hover:bg-emerald-600 text-white px-3 py-1 rounded text-xs transition">
                        <?php echo e($kit->user->prenom ?? 'N/A'); ?> (<?php echo e($kit->code_qr); ?>)
                    </button>
        ...
        <div class="mt-4 text-center">
            <a href="<?php echo e(route('collecteur.dashboard')); ?>" class="text-gray-500">← Retour</a>
        </div>
    </div>
