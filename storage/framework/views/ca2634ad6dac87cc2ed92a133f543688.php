...
<body class="bg-gray-100">
        ...
        <div class="w-72 bg-gradient-to-b from-gray-800 to-gray-900 text-white flex flex-col shadow-xl">
            ...
            <nav class="flex-1 mt-6">
                <a href="<?php echo e(route('admin.dashboard')); ?>"
                    class="flex items-center px-5 py-3 text-gray-300 hover:bg-gray-700 transition <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-gray-700 border-l-4 border-emerald-500' : ''); ?>">
                    <i class="fas fa-tachometer-alt w-5 mr-3"></i> Tableau de bord
                </a>
                <a href="<?php echo e(route('admin.utilisateurs')); ?>"
                    class="flex items-center px-5 py-3 text-gray-300 hover:bg-gray-700 transition <?php echo e(request()->routeIs('admin.utilisateurs*') ? 'bg-gray-700 border-l-4 border-emerald-500' : ''); ?>">
                    <i class="fas fa-users w-5 mr-3"></i> Utilisateurs
                </a>
                <a href="<?php echo e(route('admin.collectes')); ?>"
                    class="flex items-center px-5 py-3 text-gray-300 hover:bg-gray-700 transition <?php echo e(request()->routeIs('admin.collectes*') ? 'bg-gray-700 border-l-4 border-emerald-500' : ''); ?>">
                    <i class="fas fa-truck w-5 mr-3"></i> Collectes
                </a>
                <a href="<?php echo e(route('admin.kits')); ?>"
                    class="flex items-center px-5 py-3 text-gray-300 hover:bg-gray-700 transition <?php echo e(request()->routeIs('admin.kits*') ? 'bg-gray-700 border-l-4 border-emerald-500' : ''); ?>">
                    <i class="fas fa-box w-5 mr-3"></i> Kits commandés
                </a>
                <a href="<?php echo e(route('admin.statistiques')); ?>"
                    class="flex items-center px-5 py-3 text-gray-300 hover:bg-gray-700 transition <?php echo e(request()->routeIs('admin.statistiques*') ? 'bg-gray-700 border-l-4 border-emerald-500' : ''); ?>">
   ...
   <?php echo e(request()->routeIs('admin.recompenses*') ? 'bg-gray-700 border-l-4 border-purple-500' : ''); ?>">
            ...
            <div class="bg-white shadow-sm px-6 py-4 sticky top-0 z-10">
                <div class="flex justify-between items-center">
                    <h2 class="text-xl font-semibold text-gray-800">
                        <?php echo $__env->yieldContent('title', 'Administration'); ?>
                    </h2>
                    <div class="flex items-center gap-4">
                        <span class="text-sm text-gray-500">
                            <i class="far fa-calendar-alt mr-1"></i> <?php echo e(now()->format('d/m/Y H:i')); ?>
