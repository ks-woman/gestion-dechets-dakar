    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div class="bg-white rounded-xl shadow p-4 border-l-4 border-green-500">
                ...
                <p class="text-2xl font-bold text-green-600">{{ number_format($totalPoids->total ?? 0, 1) }} kg</p>
            </div>
        ...
        <div class="bg-white rounded-xl shadow p-4">
            <h3 class="font-semibold text-gray-800 mb-3 text-sm"> Évolution des collectes ({{ now()->year }})</h3>
            ...
            <ul class="space-y-2">
                @forelse($topClients as $client)
                    <li class="flex justify-between items-center p-2 bg-gray-50 rounded">
                        <span>{{ $client->user->prenom }} {{ $client->user->nom }}</span>
                        <span class="font-bold">{{ $client->total }} collectes</span>
                    </li>
                @empty
