...
@section('content')
    <div class="max-w-md mx-auto bg-white p-6 rounded-lg shadow">
        ...
        <form method="POST" action="{{ route('register.entreprise') }}">
            @csrf
            ...
            <div class="mb-4">
                ...
                <input type="text" name="numero_registre_commerce" value="{{ old('numero_registre_commerce') }}"
            ...
            <div class="mb-4">
                ...
                <input type="number" name="volume_moyen_dechet" value="{{ old('volume_moyen_dechet', 0) }}"
                    class="w-full border rounded p-2">
                @error('volume_moyen_dechet')
                    <div class="text-red-500 mt-1">{{ $message }}</div>
                @enderror
            </div>
